...
# Prebuilt kl keymaps
adb pull /system/usr/keylayout/mimmi_keypad.kl ../../../vendor/$VENDOR/$DEVICE/proprietary
adb pull /system/usr/keylayout/systemconnector.kl ../../../vendor/$VENDOR/$DEVICE/proprietary
adb pull /system/usr/keychars/mimmi_keypad.kcm.bin ../../../vendor/$VENDOR/$DEVICE/proprietary
